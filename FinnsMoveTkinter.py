...
class CanvasDemo (tk.Frame):
    def __init__ (self, master):
        ...
        #Ved hjælp af tags kan man tilføje en event til item. Her er format:
        # tag_bind(item, event=None, callback, add=None)

        # Se her for events and bindings: http://effbot.org/tkinterbook/tkinter-events-and-bindings.htm
    ...
    def motion (self, event):
        mitvindue.config (cursor ="exchange")
        cnv = event.widget
...
mitvindue =tk.Tk()
mitvindue.title ("Drag-N-Drop Demo")
